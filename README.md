Challenge 9: Everything is relative
===================================
...
2.  Fill the blank R code chunks in
    [challenge9\_assignment.Rmd](challenge9_assignment.Rmd)

3.  Modify the header of
    [challenge9\_assignment.Rmd](challenge9_assignment.Rmd) (you might
...
4.  Submit the Assignment (you might want to review the [relevant
    ...
    -   `challenge9_assignment.Rmd` : your modified version of the R
        Notebook that you received in your repo
    -   `challenge9_assignment.html` : the output from knitting your
